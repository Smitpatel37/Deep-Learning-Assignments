...
class EarlyStopper:
    ...
    def stopping_criterion(self, acc):
      """
      Compare the last epoch accuracy with the current accuracy. As accuracy increases for several epochs in a row, training stops.
      """
